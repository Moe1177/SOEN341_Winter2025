...
import { faBullseye, faPeopleGroup, faSms } from "@fortawesome/free-solid-svg-icons"; 
...
const content: ContentItem[] = [
  ...
  },
  {
    ...
    content: (
      <div className="h-full w-full flex items-center justify-center text-white">
        <FontAwesomeIcon icon={faPeopleGroup} className="w-full h-full text-9xl"/>
      </div>
    ),
  },
  {
  ...
  {
    title: "Meet the team",
    description: "Meet the talented individuals behind the platform. Here’s a brief introduction:",
    content: (
        ...
        <table className="min-w-full table-auto text-sm text-center animate-fadeIn text-white">
          ...
          <tbody>
            <tr>
              ...
              <td className="p-2"><a href="https://github.com/YoussefYassa7112" className="text-cyan-500">YoussefYassa7112</a></td>
            </tr>
            <tr>
              <td className="p-2">Tristan Girardi</td>
              <td className="p-2"><a href="https://github.com/TristanGirardi" className="text-cyan-500">TristanGirardi</a></td>
            </tr>
            <tr>
              <td className="p-2">Mohamad Addasi</td>
              <td className="p-2"><a href="https://github.com/Moe1177" className="text-cyan-500">Moe1177</a></td>
            </tr>
            <tr>
              <td className="p-2">Mijan Ullah</td>
              <td className="p-2"><a href="https://github.com/mijanullah12" className="text-cyan-500">mijanullah12</a></td>
            </tr>
            <tr>
              <td className="p-2">Fouad Elian</td>
              <td className="p-2"><a href="https://github.com/FouadElian" className="text-cyan-500">FouadElian</a></td>
            </tr>
            <tr>
              <td className="p-2">Junior Boni</td>
              <td className="p-2"><a href="https://github.com/RealBJr" className="text-cyan-500">RealBJr</a></td>
            </tr>
          </tbody>
        </table>
      </div>
